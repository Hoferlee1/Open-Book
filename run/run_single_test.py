"""Run training of single algorithmic tasks from CLRS with Open-Book."""
...
flags.DEFINE_list('algorithms', algo_lists2, 'Which algorithms to run.')
...
flags.DEFINE_integer('seed', rseed, 'Random seed to set')  # 5 40 16 66
...
flags.DEFINE_integer('batch_size', 2, 'Batch size used for training.')
...
flags.DEFINE_enum('processor_type', 'triplet_gmpnn',  # check  triplet_gmpnn
